                    ...
                    <div class="row g-4 mb-4">
                        <div class="col-md-6">
                            <form action="{{ route('admin.dashboard') }}" method="GET">
                                <label class="small text-secondary text-uppercase fw-bold mb-2 tracking-widest">Cerca tra le
                                    Canzoni</label>
                                <div class="input-group">
                                    <input type="text" name="search_song"
                                        class="form-control bg-main border-secondary text-dark shadow-none py-2"
                                        placeholder="Titolo..." value="{{ request('search_song') }}">
                                    <button
                                        class="btn btn-outline-secondary border-secondary px-3 text-uppercase fw-bold small"
                        ...
                        <div class="col-md-6">
                            <form action="{{ route('admin.dashboard') }}" method="GET">
                                <label class="small text-secondary text-uppercase fw-bold mb-2 tracking-widest">Cerca tra
                                    gli Artisti</label>
                                <div class="input-group">
                                    <input type="text" name="search_artist"
                                        class="form-control bg-main border-secondary text-dark shadow-none py-2"
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex gap-3">
                                                ...
                                                <a href="{{ route('admin.songs.edit', $s) }}"
                                                    class="text-secondary hover-first"><i
                                                        class="fa-solid fa-pencil"></i></a>
                                            </div>
                                        </div>
                                    @empty
                                        <div class="list-group-item bg-main text-secondary small italic py-3 text-center">
                                            Nessuna canzone trovata.</div>
                                    @endforelse
                                @endif
                                    ...
                                    @forelse($searchResultsArtists as $a)
                                        <div
                                            ...
                                            <div>
                                                ...
                                                <span class="text-secondary mx-2">|</span>
                                                <small
                                                    class="text-secondary italic text-uppercase">{{ $a->type }}</small>
                                            </div>
                                            <div class="d-flex gap-3">
                                                <a href="{{ route('admin.artists.show', $a) }}"
                                                    class="text-secondary hover-first"><i class="fa-solid fa-eye"></i></a>
                                                <a href="{{ route('admin.artists.edit', $a) }}"
                                                    class="text-secondary hover-first"><i
                                                        class="fa-solid fa-pencil"></i></a>
                                            </div>
                                        </div>
