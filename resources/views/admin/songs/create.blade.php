    ...
    <div class="container-fluid py-5 px-lg-5 bg-main min-vh-100 text-light">
        ...
        <form action="{{ route('admin.songs.store') }}" method="POST">
            ...
            <div class="row g-4 mb-4">
                <div class="col-md-3">
                    ...
                    <input type="text" name="title" id="title"
                        class="form-control bg-dark text-light border-secondary" placeholder="Es: Brividi" required>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="youtube_url" id="youtube_url"
                        class="form-control bg-dark text-light border-secondary" placeholder="Incolla URL video">
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="collaborators" id="collaborators"
                        class="form-control bg-dark text-light border-secondary" placeholder="Es: Michelangelo">
                </div>

                <div class="col-md-1">
                    <label for="position" class="form-label small text-secondary text-uppercase fw-bold">Pos.</label>
                    <input type="number" name="position" id="position"
                        class="form-control bg-dark text-light border-secondary" min="1" placeholder="1">
                </div>

                <div class="col-md-2">
                    <label for="edition_id" class="form-label small text-secondary text-uppercase fw-bold">Edizione</label>
            ...
            <div class="d-flex justify-content-end gap-3 pt-4 border-top border-secondary">
                <button type="submit" class="btn btn-secondary px-5 text-uppercase fw-bold shadow-sm">Salva
                    Canzone</button>
            </div>
        </form>
    </div>
