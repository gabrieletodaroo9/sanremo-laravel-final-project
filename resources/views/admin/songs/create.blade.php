    ...
    <form action="{{ route('admin.songs.store') }}" method="POST">
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-md-3">
                ...
                <input type="text" name="youtube_url" id="youtube_url" class="form-control bg-dark text-light border-secondary" placeholder="Incolla URL video">
            </div>
            ...
            <div class="col-md-1">
                ...
                <input type="number" name="position" id="position" class="form-control bg-dark text-light border-secondary" min="1" placeholder="1">
            </div>
