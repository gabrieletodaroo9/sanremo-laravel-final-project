    ...
    <div class="d-flex justify-content-between align-items-end mb-5 border-bottom border-secondary pb-4">
        <div>
            ...
            <p class="text-secondary mb-0 text-uppercase small tracking-widest">
                ...
                @if ($song->position)
                    <span class="ms-3 text-first">
                        <i class="fa-solid fa-trophy me-2"></i>{{ $song->position }}° Posto
                    </span>
                @endif
            </p>
        </div>
        ...
        <div class="btn-group">
            ...
            <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $song->id }}">
        ...
        <div class="col-lg-10">
            ...
            @if ($song->edition->logo_url)
                <div class="card bg-main border-0 mb-5 text-center">
                    <div class="card-body p-0 overflow-hidden rounded-1">
                        <img src="{{ asset('storage/' . $song->edition->logo_url) }}" alt="Logo Edizione" class="w-100" style="max-height: 150px; object-fit: contain; opacity: 0.8;">
                    </div>
                </div>
            @endif
            ...
            @if ($song->awards->count() > 0)
                <div class="row mb-5">
                    <div class="col-12">
                        <div class="px-2">
                            <h5 class="text-uppercase fw-bold text-secondary mb-3 border-bottom border-secondary pb-2">Riconoscimenti</h5>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content bg-light text-dark border-0">
            <div class="modal-body p-5 text-center">
                ...
                <h4 class="mb-3">Eliminare il brano?</h4>
