            ...
            <form action="{{ route('admin.editions.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-4 mb-4">
                    <div class="col-md-4">
                        ...
                        <input type="number" name="year" id="year" class="form-control bg-dark text-light border-secondary shadow-none" placeholder="2026" required>
                    </div>

                    <div class="col-md-8">
                        <label for="host" class="form-label small text-secondary text-uppercase fw-bold">Conduttore Principale</label>
                        <input type="text" name="host" id="host" class="form-control bg-dark text-light border-secondary shadow-none" placeholder="Nome del conduttore">
                    </div>
                </div>

                <div class="mb-4">
                    <label for="co_hosts" class="form-label small text-secondary text-uppercase fw-bold">Co-conduttori</label>
                    <input type="text" name="co_hosts" id="co_hosts" class="form-control bg-dark text-light border-secondary shadow-none" placeholder="Nomi separati da virgola">
                </div>

                <div class="mb-4">
                    <label for="location" class="form-label small text-secondary text-uppercase fw-bold">Sede</label>
                    <input type="text" name="location" id="location" class="form-control bg-dark text-light border-secondary shadow-none" value="Teatro Ariston">
                </div>

                <div class="mb-5">
                    <label for="logo_url" class="form-label small text-secondary text-uppercase fw-bold">Logo Edizione</label>
                    <input type="file" name="logo_url" id="logo_url" class="form-control bg-dark text-light border-secondary shadow-none">
                </div>
