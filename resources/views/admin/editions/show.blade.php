...
<div class="container-fluid py-5 px-lg-5 bg-main min-vh-100 text-light">
    ...
    <div class="d-flex justify-content-between align-items-end mb-5 border-bottom border-secondary pb-4">
        <div>
            ...
            <p class="text-secondary mb-0">
                <i class="fa-solid fa-location-dot me-2"></i>{{ $edition->location }}
            </p>
        </div>
    ...
    <div class="row g-4">
        <div class="col-lg-4">
            <div class="card bg-main border-0 text-light">
        ...
        <div class="col-lg-8">
            <div class="card bg-main border-0 text-light h-100">
                <div class="card-body p-4">
                    ...
                    @if ($edition->songs->count() > 0)
                        <div class="list-group list-group-flush">
                            @foreach ($edition->songs->sortBy('position') as $song)
                                <div class="list-group-item bg-transparent border-secondary-subtle px-0 py-3 d-flex align-items-center">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content bg-dark text-light border-secondary">
            <div class="modal-body p-5 text-center">
                ...
                <h4 class="mb-3">Confermi l'eliminazione?</h4>
                <p class="text-secondary small">L'edizione <strong>{{ $edition->year }}</strong> e i dati collegati verranno rimossi.</p>
