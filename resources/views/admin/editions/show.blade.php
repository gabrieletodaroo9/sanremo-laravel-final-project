...
<div class="container-fluid py-5 px-lg-5 bg-main min-vh-100 text-light">
    ...
    <div class="d-flex justify-content-between align-items-end mb-5 border-bottom border-secondary pb-4">
        ...
        <div class="btn-group">
            ...
            <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $edition->id }}">
    ...
    <div class="text-center mb-5">
        <img src="{{ asset('storage/' . $edition->logo_url) }}" alt="Logo" class="img-fluid" style="max-height: 150px;">
    </div>
        ...
        <div class="col-lg-4">
            <div class="card bg-dark-subtle border-0 shadow text-light">
                <div class="card-body p-4">
                    <h5 class="text-uppercase small fw-bold text-secondary mb-4 border-bottom border-secondary pb-2">Dettagli</h5>
                    <div class="mb-4">
                        <label class="d-block small text-secondary text-uppercase">Conduttore</label>
                        <span class="fs-3 fw-semibold">{{ $edition->host }}</span>
                    </div>
                    <div class="mb-0">
                        <label class="d-block small text-secondary text-uppercase">Co-conduzione</label>
                        <p class="mb-0 fw-bold fs-6">{{ $edition->co_hosts ?? 'Non ancora definiti' }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-8">
            <div class="card bg-dark-subtle border-0 shadow text-light h-100">
                <div class="card-body d-flex flex-column justify-content-center align-items-center py-5">
                    <i class="fa-solid fa-music fa-3x text-secondary mb-3 opacity-25"></i>
                    <h5 class="m-0 text-secondary">Canzoni in gara</h5>
                    <p class="small text-muted italic mt-2">Nessun brano collegato a questa edizione.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content bg-light text-light border-secondary">
            <div class="modal-body p-5 text-center">
                ...
                <p class="text-secondary">L'edizione <strong>{{ $edition->year }}</strong> del festival di Sanremo verrà rimossa definitivamente dal database.</p>
