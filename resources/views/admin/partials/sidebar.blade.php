<div class="offcanvas-xl offcanvas-start col-lg-2 bg-light shadow-sm border-end p-0" tabindex="-1" id="sidebarOffcanvas">
    
    <div class="offcanvas-header d-xl-none border-bottom mb-4">
        <div class="p-0 p-lg-5 text-lg-center">
    ...
    <div class="sticky-top d-flex flex-column vh-100">
        ...
        <h4 class="px-4 px-xl-5 pb-3 fw-bold d-none d-lg-block">Menu</h4>
        ...
        <div class="mt-auto ps-4 ps-lg-5 pb-3 pb-lg-5">
