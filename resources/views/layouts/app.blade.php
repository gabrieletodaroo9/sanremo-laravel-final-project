...
<body class="h-100">
    <div id="app" class="d-flex flex-column min-vh-100">
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand d-flex align-items-center" href="{{ url('/') }}">
                    <div class="logo_laravel py-2">
                        <img src="https://sanremissimo.it/wp-content/uploads/2025/01/affittacamere-a-sanremo-768x218.png" style="height:50px" alt="">
                    </div>
        ...
        <main class="bg-main flex-grow-1">
            @yield('content')
        </main>
    </div>
</body>
